    ...
    <article className="group bg-white rounded-2xl shadow-soft hover:shadow-soft-lg transition-all duration-300 overflow-hidden border border-warm-100 hover:border-primary-200">
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4">
          {speakerName ? (
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-warm-100 text-warm-700 rounded-full text-sm font-medium">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-warm-50 text-warm-400 rounded-full text-sm">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
              Onbekende spreker
