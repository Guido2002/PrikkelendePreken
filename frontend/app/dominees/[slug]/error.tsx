...
export default function DomineeDetailError({
  error,
  reset,
}: Readonly<{
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="bg-white border border-warm-100 rounded-2xl shadow-soft p-6 sm:p-10">
        <h1 className="text-2xl sm:text-3xl font-bold text-warm-900 font-serif">Dit profiel kon niet geladen worden</h1>
        <p className="mt-3 text-warm-600">Probeer opnieuw, of ga terug naar het overzicht.</p>
