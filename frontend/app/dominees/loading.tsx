      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {Array.from({ length: 9 }).map((_, i) => (
            <div key={i} className="bg-white dark:bg-warm-900/40 rounded-2xl border border-warm-100 dark:border-warm-800/60 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-warm-100 dark:border-warm-800">
